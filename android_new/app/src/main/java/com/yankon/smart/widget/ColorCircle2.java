...
public class ColorCircle2 extends View {
    ...
    private final static float CENTER_RADIUS_SCALE = 0.3f;
     ...
     */
    public ColorCircle2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    void init() {
        ...
        dr_mode_0 = getResources().getDrawable(R.drawable.cp_mode_predefined);
        dr_mode_1 = getResources().getDrawable(R.drawable.cp_mode_picker);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float touch_feedback_ring = center_radius;
        ...
        mCenterPaint.setColor(center_color);
        canvas.drawCircle(0, 0, center_radius - 10, mCenterPaint);
        switch (mode) {
            case MODE_PREDEFINED:
                dr_mode_0.draw(canvas);
                break;
            case MODE_PICKER:
                dr_mode_1.draw(canvas);
                break;
        }
//        if (mTrackingCenter) {
...
//        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int value = (int) ( center_radius / 2);
        dr_mode_0.setBounds( - value, - value, value, value);
        dr_mode_1.setBounds( - value, - value, value, value);
