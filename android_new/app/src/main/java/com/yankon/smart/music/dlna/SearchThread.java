...
public class SearchThread extends Thread {
	...
	private static final int mFastInternalTime = 1500;
	private static final int mNormalInternalTime = 5000;
	...
	private DeviceChangeListener mDeviceChangeListener = new DeviceChangeListener() {
		...
		public void deviceAdded(Device dev) {
			Log.e(TAG, "control point add a device..." + dev.getDeviceType()
					+ dev.getFriendlyName() + "-----" + dev.getSSDPPort() +
					"----" + dev.getHTTPPort());
