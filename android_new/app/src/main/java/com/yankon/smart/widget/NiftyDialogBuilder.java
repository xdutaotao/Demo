...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private final String defDividerColor="#FFFFCC00";
    ...
    public NiftyDialogBuilder setButton1Visibility(int view) {
        mButton1.setVisibility(view);
        return this;
    }

    public NiftyDialogBuilder setButton2Visibility(int view) {
        mButton2.setVisibility(view);
        return this;
    }
