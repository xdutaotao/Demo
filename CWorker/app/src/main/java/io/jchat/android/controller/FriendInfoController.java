    ...
    public void onClick(final View v) {
        ...
        switch (v.getId()) {
            case R.id.friend_info_return_btn:
                ...
                intent.putExtra(App.NICKNAME, nickname);
                mContext.setResult(App.RESULT_CODE_FRIEND_INFO, intent);
                mContext.finish();
                break;
...
//                mContext.startActivityForResult(intent, App.REQUEST_CODE_EDIT_NOTENAME);
                break;
