...
public class PickPictureActivity extends BaseActivity {
    ...
    private OnItemClickListener onItemListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> viewAdapter, View view, int position, long id) {
            ...
            startActivityForResult(intent, App.REQUEST_CODE_BROWSER_PICTURE);
        }
    };
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == App.RESULT_CODE_SELECT_PICTURE) {
            if (data != null) {
        ...
        } else if (resultCode == App.RESULT_CODE_BROWSER_PICTURE) {
            setResult(App.RESULT_CODE_SELECT_ALBUM, data);
            finish();
        }
    }
            ...
            if (activity != null) {
                switch (msg.what) {
                    case SEND_PICTURE:
                        ...
                        activity.setResult(App.RESULT_CODE_SELECT_ALBUM, intent);
