...
public class MainActivity extends FragmentActivity {
    ...
    protected void onResume() {
        ...
        if (myInfo == null) {
            ...
            App.setPicturePath(myInfo.getAppKey());
...
//                mMainController.cropRawPhoto(mUri);
                    ...
                    startActivityForResult(intent, App.REQUEST_CODE_CROP_PICTURE);
                }
            }
        } else if (requestCode == App.REQUEST_CODE_SELECT_PICTURE) {
            if (data != null) {
        ...
        } else if (requestCode == App.REQUEST_CODE_CROP_PICTURE) {
//            mMainController.uploadUserAvatar(mUri.getPath());
            String path = data.getStringExtra("filePath");
            if (path != null) {
                mMainController.uploadUserAvatar(path);
            }
        } else if (resultCode == App.RESULT_CODE_ME_INFO) {
