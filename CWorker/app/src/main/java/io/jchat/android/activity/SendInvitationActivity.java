...
public class SendInvitationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String targetAppKey = getIntent().getStringExtra(App.TARGET_APP_KEY);
        final String targetAvatar = getIntent().getStringExtra(App.AVATAR);
        final String displayName = getIntent().getStringExtra(App.NICKNAME);
