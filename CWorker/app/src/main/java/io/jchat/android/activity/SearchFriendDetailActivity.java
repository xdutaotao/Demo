            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case R.id.add_to_friend:
                        ...
                        intent.putExtra(App.AVATAR, mAvatarPath);
                        intent.putExtra(App.TARGET_APP_KEY, mAppKey);
                        intent.putExtra(App.NICKNAME, mDisplayName);
                    ...
                    case R.id.bt_chat:
                        ...
                        intentChat.putExtra(App.CONV_TITLE, title);
                        intentChat.putExtra(App.TARGET_ID, mToUserInfo.getUserName());
                        intentChat.putExtra(App.TARGET_APP_KEY, mToUserInfo.getAppKey());
