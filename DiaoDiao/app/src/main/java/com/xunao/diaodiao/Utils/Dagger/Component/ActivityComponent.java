...
import com.xunao.diaodiao.Activity.EditBankActivity;
...
public interface ActivityComponent {
    ...
    void inject(OrderSkillTabFinishFragment fragment);
    ...
    void inject(OrderSkillCompDetailActivity activity);
    void inject(OrderSkillCompRecieveDetailActivity activity);
    ...
    void inject(EditBankActivity activity);
}